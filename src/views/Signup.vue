      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form @submit.prevent="handleSignup" class="space-y-6">
          <div>
            ...
            <div class="mt-2">
              <Input v-model="displayName" size="md" type="text" required/>
            </div>
          </div>
          <div>
          ...
          <div class="m-auto flex justify-center">
            <button v-if="!isPending" type="submit" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2">Sign up</button>
